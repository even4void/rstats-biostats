...
Outre la possibilité d'utiliser `Predict`{pkg="rms"} (_P_ majuscule) pour former des prédictions marginales avec ou sans ajustement, il existe une interface avec le package ggplot2. Voici un exemple d'application :
