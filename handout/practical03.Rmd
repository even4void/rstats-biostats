...
> Le modèle de régression de Cox est un modèle semi-paramétrique simple dans lequel on modélise la fréquence instantanée de l'événement d'intérêt, appelé "hazard", en fonction de variables explicatives sous la forme $ \log[h(t;x_1,x_2,\dots)] = \log[h_0(t)] + \beta_1x_1 + \beta_2x2 + \dots $.
