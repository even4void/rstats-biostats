...
2. En utilisant une procédure de sélection automatique (`step()`), indiquer parmi l'ensemble des variables du _data frame_ lesquelles pourraient être considérées comme significatives au seuil de 5 %, sans tenir compte des problèmes inhérents à la sélection pas à pas.
