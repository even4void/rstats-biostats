...
On peut représenter la probabilité de survie au cours du temps à l'aide d'une courbe de Kaplan-Meier : en l'absence de censure, celle-ci représente directement la proportion de décès.
```{r}
