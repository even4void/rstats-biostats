...
Table of counts of wheezing status (Yes/No) for N = 537 children aged 7 to 10 years, with following two factors: maternal smok- ing (smoke, considered fixed) and time (age).
What is the marginal expectation of chil- dren’s response as a function of these co- variates (including the interaction smoke:time)?
